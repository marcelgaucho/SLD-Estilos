...
<sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <sld:UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>BC250_Edif_Industrial_P</sld:Name>
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
          <sld:Name>Edif Industrial P</sld:Name>
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:Mark>
              ...
              <sld:Rotation>85.0</sld:Rotation>
            </sld:Graphic>
          </sld:PointSymbolizer>
          <sld:PointSymbolizer>
            <sld:Graphic>
              ...
              <sld:Rotation>255.0</sld:Rotation>
            </sld:Graphic>
          </sld:PointSymbolizer>
          <sld:PointSymbolizer>
            <sld:Graphic>
              ...
              <sld:Rotation>125.0</sld:Rotation>
            </sld:Graphic>
          </sld:PointSymbolizer>
          <sld:PointSymbolizer>
            <sld:Graphic>
            ...
            <sld:LabelPlacement>
              <sld:PointPlacement>
                ...
                <sld:Displacement>
                  ...
                  <sld:DisplacementY>-13.0</sld:DisplacementY>
                </sld:Displacement>
              </sld:PointPlacement>
            </sld:LabelPlacement>
            <sld:Halo>
